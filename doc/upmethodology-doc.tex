...
\hline
nopubpage & do not invoke \texttt{{\textbackslash}upmpublicationpage} command at the begining of the document. This option overrides any 
...
\begin{upmcaution}
	The following command is deprecated: \texttt{{\textbackslash}tabulartitle}. \end{upmcaution}
