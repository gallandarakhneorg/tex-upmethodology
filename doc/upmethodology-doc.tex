...
\subsubsection{Specify the Caption as Table Title}
...
This macro allows you to define the title of the tabular in the table. It uses the colors \texttt{backtableheader} and \texttt{fronttableheader} for the background and the foreground respectively. The title has a single line at the top, and a single line below;

\paragraph{Syntax} \texttt{{\textbackslash}captionastitle}

\paragraph{Example} See Table \tabref{example:mtable} in the previous section.
