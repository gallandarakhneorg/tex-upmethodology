...
\item \texttt{{\textbackslash}pageref\{$\langle$label of the theorem$\rangle$:$\langle$Label of the theorem$\rangle$\}} for showing the definition's page, e.g., \defpageref{thm:mytheo2} for the theorem above.
\end{itemize}
